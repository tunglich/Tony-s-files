                          ...
                          fluidPage(
                            tabsetPanel(id = "myRobot", type = "tabs",
                                        tabPanel(title = "Data Table",
                                                  ...
                                                  h4("請輸入目前投資的基金(直接點選下表): "),br()
                                                                 ,
                                                DT::dataTableOutput("table"),br(),
                                                column(12, verbatimTextOutput("myPort"), h4("輸入完成後請按確認!")
                                                       , actionButton("fundGo", "確認"), br(), br()),
                                                column(12, dataTableOutput("table_selected"), br(), br()),
                                                column(12, rHandsontableOutput("hstable"), br()),
                                                column(12, h4("請輸入原始投資金額(Initial_investment), 和申購日期(Date), 輸入完成後請按確認!")
                                                       , actionButton("fundGo1", "確認"), br(), br())
